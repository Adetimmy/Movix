  ...
  return (
    <nav className='min-w-screen min-h-screen relative'>
      <div className='bg-transparent absolute top-0 z-20 pt-3 px-2 sm:px-7 md:px-24 mb-24 w-full'>
        ...
        <div className='md:hidden absolute right-0 bottom-[150px] w-10 h-10 bg-orange-500 p-1 rounded-l-full backdrop-blur-lg shadow-sm cursor-pointer z-20 animate-pulse'>
          <Link href={'#next'}>
